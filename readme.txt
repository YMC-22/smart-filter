...
For example, instead of ymc_after_custom_layout_ID should be set to: ymc_after_custom_layout_FilterID_LayoutID where:
- FilterID - filter ID (cpt)
- LayoutID - filter numbering on the page
= 1.2.8 =
